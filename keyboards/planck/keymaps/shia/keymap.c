...
[_RAISE] = {
  ...
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_LFT_TAB, KC_RGT_TAB, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______,    _______,    _______, _______, _______},
  {_______, _______, _______, _______, _______, _______, _______, _______,    _______,    _______, _______, _______}
},
 ...
 */
[_ADJUST] = {
  {_______, RESET,   _______, _______, _______, _______, _______, _______, _______, _______, TG(_PS4), _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______},
  {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______}
},
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Shift |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  |   2  |   3  |   4  | Lower|    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_PS4] = {
  {KC_TAB,  KC_Q, KC_W, KC_E, KC_R,  KC_T,   KC_Y,   KC_U,  KC_I,    KC_O,    KC_P,    BCK_ESC},
  ...
  {KC_LSFT, KC_Z, KC_X, KC_C, KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT},
  {KC_ESC,  KC_2, KC_3, KC_4, LOWER, KC_SPC, KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
}
};
